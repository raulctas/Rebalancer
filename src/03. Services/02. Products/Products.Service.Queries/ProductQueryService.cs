...
namespace Catalog.Service.Queries
{
    ...
    {
        Task<DataCollection<ProductDto>> GetAllAsync(int page, int take, IEnumerable<string> products = null);
    ...
    public class ProductQueryService : IProductQueryService
    {
        ...
        public async Task<DataCollection<ProductDto>> GetAllAsync(int page, int take, IEnumerable<string> products = null)
        {
